...
import type { Notification } from "@/types/forex"
import { fetchForexData, fetchMarketData, checkMarketStatus } from "@/services/api"
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const weeklyPerformance = [
        {
          day: "Mon",
          pips: Math.round((Math.random() * 40 - 10) * 10) / 10,
