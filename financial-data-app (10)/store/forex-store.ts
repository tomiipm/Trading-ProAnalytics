...
import type { ForexSignal, PerformanceStats, WeeklyPerformanceData, Notification } from "@/types/forex"
    ...
    (set, get) => ({
      ...
      toggleFavorite: (id: string) => {
        ...
        set({
          ...
          selectedSignal:
            selectedSignal && selectedSignal.id === id
      ...
      setMarketStatus: (isOpen: boolean, session: string | null) => {
        ...
        const notification: Notification = {
          ...
          message: isOpen
            ? `Forex market is open. Current session: ${session}.`
