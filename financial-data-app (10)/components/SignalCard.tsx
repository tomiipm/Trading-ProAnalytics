  ...
  return (
    ...
    >
      {signal.isPremium && !isPremium && (
        <LinearGradient colors={["rgba(0, 0, 0, 0.7)", "rgba(0, 0, 0, 0.5)"]} style={styles.premiumOverlay}>
      ...
      <View style={styles.content}>
        <View style={styles.leftContent}>
          ...
          >
            ...
            <Text style={[styles.type, { color: signal.type === "BUY" ? darkTheme.buy : darkTheme.sell }]}>
              {signal.type}
            </Text>
          </View>
